...
/**
 * Известные ключи, которые сейчас читает сайт (src/pages/guide.js и форум).
 * Список не жёсткий: у текста нет проверки формата ключа, страница просто
 * не найдёт незнакомый и промолчит. Но подсказать редактору правильное имя —
 * дешевле, чем потом объяснять, почему раздел на сайте не появился.
 *
 * forum-theme — еженедельная тема форума (баннер «Тема недели»). Тот же ключ
 * держит src/pages/forum.js (FORUM_THEME_KEY); расхождение ловит тест.
 */
export const KNOWN_TEXT_KEYS = ['guide-intro', 'guide-principles', 'guide-week', 'guide-donts', 'guide-benefits', 'forum-theme'];

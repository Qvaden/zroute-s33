 ...
 * инструкции: как выпустить токен владельцу и как — приглашённому помощнику
 ...
 *
 * Это работало, но означало, что помощников нет. Объяснять человеку, что такое
 * personal access token, ради правки счёта в VS — заведомо проигрышная затея,
 * и на практике никого не приглашали.
 *
 * Теперь вход тот же, что на форуме: ник и пароль. Роль выдаётся нажатием
 * в панели, у нового модератора нет ни одного лишнего шага. Инструкции
      ...
      <section class="adm-login__card">
        ...
        <details class="adm-help">
          ...
          <ol>
            ...
            <li>Скажите владельцу свой ник</li>
            <li>Возвращайтесь сюда</li>
          </ol>
          <p class="muted">
            Забытый пароль восстанавливает сам игрок: на странице форума есть
            шаг «Забыли пароль?», через 12 часов заявка принимает новый пароль
            сама. Ваше дело — отклонить чужую во вкладке «Игроки». Паролей вы
            не видите — ни старого, ни нового.
          </p>
        </details>

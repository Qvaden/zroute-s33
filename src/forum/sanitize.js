 ...
 * Нужна не только очистке: плоский текст с &nbsp; из редактора показывается
 * и через абзацы, и через выжимки — без декода esc() превратит сущность
 * в «&amp;nbsp;», и человек увидит служебные буквы прямо в сообщении.
 */

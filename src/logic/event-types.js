 ...
 *   Хронология  — что делал сервер целиком: брал чужие Столицы и защищал свою.
 ...
 *   При защите    — КТО НАПАДАЛ. Защищаем мы только свою Столицу 33 сервера
 *                   и никакую другую, поэтому «чей» тут вопрос без смысла,
...
export const EVENT_TYPE = {
  server_capture: {
    label: 'Захват Столицы',
    filter: 'Захваты',
    kind: 'win',
    action: 'capture',
    /** Подпись поля с номером сервера в панели. */
    numberLabel: 'Чья Столица',
    numberHint: 'номер чужого сервера, например 74',
    verdict: (n) => `Захватили Столицу сервера ${n}`,
    verdictNoNumber: 'Захватили чужую Столицу',
    pill: (n) => (n != null ? `взяли ${n}` : 'взяли Столицу'),
  },
  capture_failed: {
    ...
    verdict: (n) => `Проиграли захват Столицы сервера ${n}`,
    verdictNoNumber: 'Захват чужой Столицы не удался',
    pill: (n) => (n != null ? `не взяли ${n}` : 'не взяли'),
  },
  server_defended: {
    label: 'Защитили Столицу',
    filter: 'Защиты',
    kind: 'win',
    action: 'defense',
    numberLabel: 'Кто нападал',
    numberHint: 'номер сервера, который шёл на нас',
    verdict: (n) => `Успешно защитили свою Столицу от сервера ${n}`,
    verdictNoNumber: 'Успешно защитили свою Столицу',
    pill: (n) => (n != null ? `отбились от ${n}` : 'отбились'),
  },
  server_lost: {
    label: 'Не защитили Столицу',
    filter: 'Потери',
    kind: 'loss',
    action: 'defense',
    numberLabel: 'Кто нападал',
    numberHint: 'номер сервера, который нас взял',
    verdict: (n) => `Не смогли защитить Столицу от сервера ${n}`,
    verdictNoNumber: 'Не смогли защитить свою Столицу',
 ...
 * «чьи Столицы забрали и свою ли удержали».
 *

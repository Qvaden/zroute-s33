...
import { loadAll, capabilities, db } from './data/index.js?v=62';
import { validateDataset } from './data/contract.js?v=62';
import {
  computeStandings,
  computeWeekSummary,
  computeMovers,
  ...
  computeWindowForm,
} from './logic/standings.js?v=62';
import { renderHome } from './pages/home.js?v=62';
import { renderLadder } from './pages/ladder.js?v=62';
import { renderQuarter } from './pages/quarter-final.js?v=62';
import { renderTimeline } from './pages/timeline.js?v=62';
import { renderGuide } from './pages/guide.js?v=62';
import { renderBot } from './pages/bot.js?v=62';
import { renderAbout } from './pages/about.js?v=62';
import { renderAlliance } from './pages/alliance.js?v=62';
import { computeAchievements } from './logic/achievements.js?v=62';
import { esc } from './ui/helpers.js?v=62';
import { presidentBoardFromTexts } from './logic/president-board.js?v=62';
import { startQuarterTimer } from './ui/quarter-timer.js?v=62';
// Побочные импорты: вешают делегированные обработчики фильтров на страницах.
import './ui/ladder-controls.js?v=62';
import './ui/timeline-controls.js?v=62';
import { mountForum, mountUser, unmountForum } from './forum/mount.js?v=62';
import { mountChats, unmountChats, unreadChatsTotal } from './forum/chats.js?v=62';
import { mountTournaments, unmountTournaments } from './forum/tournaments.js?v=62';
import { mountGuides, unmountGuides } from './forum/guides.js?v=62';
import { mountCalendar, unmountCalendar } from './forum/calendar.js?v=62';

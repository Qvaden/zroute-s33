...
import { loadAll, capabilities, db } from './data/index.js?v=56';
import { validateDataset } from './data/contract.js?v=56';
import {
  computeStandings,
  computeWeekSummary,
  computeMovers,
  ...
  computeWindowForm,
} from './logic/standings.js?v=56';
import { renderHome } from './pages/home.js?v=56';
import { renderLadder } from './pages/ladder.js?v=56';
import { renderQuarter } from './pages/quarter-final.js?v=56';
import { renderTimeline } from './pages/timeline.js?v=56';
import { renderGuide } from './pages/guide.js?v=56';
import { renderBot } from './pages/bot.js?v=56';
import { renderAbout } from './pages/about.js?v=56';
import { renderAlliance } from './pages/alliance.js?v=56';
import { computeAchievements } from './logic/achievements.js?v=56';
import { esc } from './ui/helpers.js?v=56';
import { presidentBoardFromTexts } from './logic/president-board.js?v=56';
import { startQuarterTimer } from './ui/quarter-timer.js?v=56';
// Побочные импорты: вешают делегированные обработчики фильтров на страницах.
import './ui/ladder-controls.js?v=56';
import './ui/timeline-controls.js?v=56';
import { mountForum, mountUser, unmountForum } from './forum/mount.js?v=56';
import { mountChats, unmountChats, unreadChatsTotal } from './forum/chats.js?v=56';
import { mountTournaments, unmountTournaments } from './forum/tournaments.js?v=56';
import { mountGuides, unmountGuides } from './forum/guides.js?v=56';

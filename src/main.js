...
import { loadAll, capabilities, db } from './data/index.js?v=57';
import { validateDataset } from './data/contract.js?v=57';
import {
  computeStandings,
  computeWeekSummary,
  computeMovers,
  ...
  computeWindowForm,
} from './logic/standings.js?v=57';
import { renderHome } from './pages/home.js?v=57';
import { renderLadder } from './pages/ladder.js?v=57';
import { renderQuarter } from './pages/quarter-final.js?v=57';
import { renderTimeline } from './pages/timeline.js?v=57';
import { renderGuide } from './pages/guide.js?v=57';
import { renderBot } from './pages/bot.js?v=57';
import { renderAbout } from './pages/about.js?v=57';
import { renderAlliance } from './pages/alliance.js?v=57';
import { computeAchievements } from './logic/achievements.js?v=57';
import { esc } from './ui/helpers.js?v=57';
import { presidentBoardFromTexts } from './logic/president-board.js?v=57';
import { startQuarterTimer } from './ui/quarter-timer.js?v=57';
// Побочные импорты: вешают делегированные обработчики фильтров на страницах.
import './ui/ladder-controls.js?v=57';
import './ui/timeline-controls.js?v=57';
import { mountForum, mountUser, unmountForum } from './forum/mount.js?v=57';
import { mountChats, unmountChats, unreadChatsTotal } from './forum/chats.js?v=57';
import { mountTournaments, unmountTournaments } from './forum/tournaments.js?v=57';
import { mountGuides, unmountGuides } from './forum/guides.js?v=57';

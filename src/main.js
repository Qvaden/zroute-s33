...
import { loadAll, capabilities, db } from './data/index.js?v=48';
import { validateDataset } from './data/contract.js?v=48';
import {
  computeStandings,
  computeWeekSummary,
  computeMovers,
  ...
  computeWindowForm,
} from './logic/standings.js?v=48';
import { renderHome } from './pages/home.js?v=48';
import { renderLadder } from './pages/ladder.js?v=48';
import { renderQuarter } from './pages/quarter-final.js?v=48';
import { renderTimeline } from './pages/timeline.js?v=48';
import { renderGuide } from './pages/guide.js?v=48';
import { renderBot } from './pages/bot.js?v=48';
import { renderAbout } from './pages/about.js?v=48';
import { renderAlliance } from './pages/alliance.js?v=48';
import { computeAchievements } from './logic/achievements.js?v=48';
import { esc } from './ui/helpers.js?v=48';
import { presidentBoardFromTexts } from './logic/president-board.js?v=48';
import { startQuarterTimer } from './ui/quarter-timer.js?v=48';
// Побочные импорты: вешают делегированные обработчики фильтров на страницах.
import './ui/ladder-controls.js?v=48';
import './ui/timeline-controls.js?v=48';
import { mountForum, mountUser, unmountForum } from './forum/mount.js?v=48';
import { mountChats, unmountChats, unreadChatsTotal } from './forum/chats.js?v=48';
import { mountTournaments, unmountTournaments } from './forum/tournaments.js?v=48';
import { mountGuides, unmountGuides } from './forum/guides.js?v=48';
